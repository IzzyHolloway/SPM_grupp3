...
ACharacterPaula::ACharacterPaula()
{
...
void ACharacterPaula::BeginPlay()
{
	Super::BeginPlay();
...
void ACharacterPaula::Tick(float DeltaTime)
{
...
void ACharacterPaula::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInput = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		if (MoveAction)
		{
			EnhancedInput->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACharacterPaula::Move);
		}

		if (LookAction)
		{
			EnhancedInput->BindAction(LookAction, ETriggerEvent::Triggered, this, &ACharacterPaula::Look);
		}
		
		if (InteractAction)
		{
			EnhancedInput->BindAction(InteractAction, ETriggerEvent::Started, this, &ACharacterPaula::Interact);
		}
		
		if (JumpAction)
		{
			EnhancedInput->BindAction(JumpAction, ETriggerEvent::Started, this, &ACharacterPaula::StartJump);
			EnhancedInput->BindAction(JumpAction, ETriggerEvent::Completed, this, &ACharacterPaula::StopJump);
		}
		
		if (DebugSolveIsland1Action)
		{
			EnhancedInput->BindAction(DebugSolveIsland1Action, ETriggerEvent::Started, this, &ACharacterPaula::DebugSolveIsland1);
		}
		
		if (DebugCraftLanternAction)
		{
			EnhancedInput->BindAction(DebugCraftLanternAction, ETriggerEvent::Started, this, &ACharacterPaula::DebugCraftLantern);
		}
...
void ACharacterPaula::Move(const FInputActionValue& Value)
{
	const FVector2D MovementVector = Value.Get<FVector2D>();
...
void ACharacterPaula::Look(const FInputActionValue& Value)
{
...
void ACharacterPaula::Interact(const FInputActionValue& Value)
{
...
void ACharacterPaula::UpdateInteractableCandidate()
{
	if (!GetWorld())
	{
		return;
...
void ACharacterPaula::SetCurrentInteractable(AInteractableActor* NewInteractable)
{
...
void ACharacterPaula::StartJump()
{
	Jump();
}

void ACharacterPaula::StopJump()
{
	StopJumping();
}

/******* WARNING: DEBUG FUNCTIONS! REMOVE LATER!!!! ********/
void ACharacterPaula::DebugSolveIsland1()
{
	if (!bEnableDebugKeys)
	{
		return;
...
void ACharacterPaula::DebugCraftLantern()
{
...
void ACharacterPaula::RemoveBoatInReach()
{
	BoatInReach = nullptr;
}
